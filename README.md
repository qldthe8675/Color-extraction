...
![Ghithub logo]([ANN architecture for color extraction.png](https://github.com/qldthe8675/Color-extraction/blob/main/ANN%20architecture%20for%20color%20extraction.png))
